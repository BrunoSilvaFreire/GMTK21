...
namespace Plugins.DOTween.Modules {
    public static class DOTweenModulePhysics2D {
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOMoveX(this Rigidbody2D target, float endValue,
            float duration, bool snapping = false) {
            var t = DG.Tweening.DOTween.To(() => target.position, target.MovePosition, new Vector2(endValue, 0),
                duration);
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOMoveY(this Rigidbody2D target, float endValue,
            float duration, bool snapping = false) {
            var t = DG.Tweening.DOTween.To(() => target.position, target.MovePosition, new Vector2(0, endValue),
                duration);
        ...
        public static Sequence DOJump(this Rigidbody2D target, Vector2 endValue, float jumpPower, int numJumps,
            ...
            Tween yTween = DG.Tweening.DOTween.To(() => target.position, x => target.position = x,
        ...
        public static TweenerCore<Vector3, Path, PathOptions> DOPath(
            ...
            var t = DG.Tweening.DOTween.To(PathPlugin.Get(), () => target.position, x => target.MovePosition(x),
