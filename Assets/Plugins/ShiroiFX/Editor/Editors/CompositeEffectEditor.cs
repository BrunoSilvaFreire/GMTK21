...
namespace Shiroi.FX.Editor.Editors {
    ...
    public class CompositeEffectEditor : UnityEditor.Editor {
        public static readonly GUIContent CompositeEffectTitle = new(
            "Composite Effect"
        );

        public static readonly GUIContent CompositeEffectSubtitle = new(
        ...
        public override void OnInspectorGUI() {
            ...
            if (r) PopupWindow.Show(buttonRect, effectSelector);
            ...
            foreach (var subEffect in effect.Effects) {
                ...
                if (remove) toRemove.Add(subEffect);
            }
            ...
            if (toRemove.Count > 0) AssetDatabase.SaveAssets();
