...
namespace Shiroi.FX.Editor.Editors {
    ...
    public class ObjectShakeEffectEditor : UnityEditor.Editor {
        public static readonly GUIContent Title = new("Object Shake Effect");

        public static readonly GUIContent Subtitle =
            new("Shakes an object using the provided parameters, useful to display damage");

        public static readonly GUIContent DimensionsContent =
            new("Dimensions", "If a dimension is not set, it will be ignored by the shake");

        public static readonly EffectHeader EffectHeader = new(typeof(ObjectShakeEffect));
