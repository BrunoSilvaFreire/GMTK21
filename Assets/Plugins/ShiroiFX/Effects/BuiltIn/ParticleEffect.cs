...
namespace Shiroi.FX.Effects.BuiltIn {
    ...
    public sealed class ParticleEffect : Effect {
        ...
        public override void Play(EffectContext context) {
            ...
            if (color != null) SetParticleColor(instance, color.Color);

            if (gradient != null) SetParticleColor(instance, gradient.Gradient);

            if (minMaxColor != null) SetParticleColor(instance, minMaxColor);

            if (minMaxGradient != null) SetParticleColor(instance, minMaxGradient);
            ...
            if (!ForceDestroyOnFinished) return;

            var main = instance.main;
            main.stopAction = ParticleSystemStopAction.Destroy;
            if (!main.playOnAwake) instance.Play();
        }
